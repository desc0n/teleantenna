    ...
    <div class="row">
        <div class="post-nav ">
            <ol class="breadcrumb">
                ...
                <?=((Arr::get($product_info,'group_1', 0) != 0 || Arr::get($product_info,'group_2', 0) != 0) ? '<li '.(Arr::get($product_info,'group_2', 0) == 0 ? ' class="active">' : '><a href="/catalog/?group_1='.Arr::get($product_info,'group_2_parent_id', 0).'">')
                    .Arr::get($product_info,'group_1_name').(Arr::get($product_info,'group_2', 0) == 0 ? '' : '</a>').'</li>'
                    : '');?>
                <?=Arr::get($product_info,'group_2', 0) != 0 ?
                    '<li '.(Arr::get($product_info,'group_3', 0) == 0
                        ? ' class="active">'
                        : '><a href="/catalog/?group_2='.Arr::get($product_info,'group_3_parent_id', 0).'">')
                    .Arr::get($product_info,'group_2_name').(Arr::get($product_info,'group_3', 0) == 0 ? '' : '</a>').'</li>'
                    : '';?>
            </ol>
        </div>
    </div>
